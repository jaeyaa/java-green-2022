...
public class MethEx04 {
    ...
    // 호랑이 -> 곰
    static void attackTigerToBear(호랑이1 unit1, 곰 unit2) {
        System.out.println(unit2.name + "가 공격당하고 있습니다.");
        unit2.hp = unit2.hp - unit1.attack;
        System.out.println(unit2.name + "의 hp : " + unit2.hp);
    }
    ...
    // 사자 -> 곰
    static void attackLionToBear(사자1 unit1, 곰 unit2) {
        System.out.println(unit2.name + "가 공격당하고 있습니다.");
        unit2.hp = unit2.hp - unit1.attack;
        System.out.println(unit2.name + "의 hp : " + unit2.hp);
    }
    ...
    // 곰 -> 호랑이
    static void attackBearToTiger(곰 unit1, 호랑이1 unit2) {
        System.out.println(unit2.name + "가 공격당하고 있습니다.");
        unit2.hp = unit2.hp - unit1.attack;
        System.out.println(unit2.name + "의 hp : " + unit2.hp);
    }
    ...
    // 곰 -> 사자
    static void attackBearToLion(곰 unit1, 사자1 unit2) {
        System.out.println(unit2.name + "가 공격당하고 있습니다.");
        unit2.hp = unit2.hp - unit1.attack;
        System.out.println(unit2.name + "의 hp : " + unit2.hp);
    }
